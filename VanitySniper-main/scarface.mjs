...
const config = {
    ...
    webhook: "webhookGir",
    password: "sifreGir",
    discordToken: "tokenGir",
    guildId: "sunucuIdGir",
    gatewayUrl: "wss://gateway-us-east1-b.discord.gg",
    os: "discord.gg/britanya",
    browser: "discord.gg/112",
    device: "calisk4n"
};
        ...
        if (t === "GUILD_UPDATE") {
            ...
            d.guilds.forEach((guild) => {
                if (guild.vanity_url_code) {
                    ...
                    console.log(`\x1b[35mAKAMİ/EMRE\x1b[0m || \x1b[31mGUILD => ${guild.id}\x1b[0m || \x1b[34mVANITY => ${guild.vanity_url_code}\x1b[0m`);
                }
            });
            
        console.log(`\x1b[ rRaté sana başarılar diler orospunun evladı!\x1b`);
        }
...
const headers = {
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) calisk4n/1.0.9164 Chrome/124.0.6367.243 Electron/30.2.0 Safari/537.36',
